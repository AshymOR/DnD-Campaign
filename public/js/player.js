$(document).ready(function () {
    ...
    $(".charClass").change(function() {
        ...
        if (charClass == "barbarian") {
            charSprite = "/public/images/Sprites/male/Barbarian/pose3.png";
            $(".infoTitle").empty();
            ...
            charSprite = "/public/images/Sprites/male/Bard/pose3.png";
            $(".infoTitle").empty();
            $(".infoTitle").html("Bard");
            $(".infoText").empty();
            ...
            charSprite = "/public/images/Sprites/male/Cleric/pose3.png";
            $(".infoTitle").empty();
            ...
            charSprite = "/public/images/Sprites/male/Druid/pose3.png";
            $(".infoTitle").empty();
            ...
            charSprite = "/public/images/Sprites/male/Fighter/pose3.png";
            $(".infoTitle").empty();
            ...
            charSprite = "/public/images/Sprites/male/Monk/pose3.png";
            $(".infoTitle").empty();
            $(".infoTitle").html("Monk");
            $(".infoText").empty();
            ...
            charSprite = "/public/images/Sprites/male/Paladin/pose3.png";
            $(".infoTitle").empty();
            ...
            charSprite = "/public/images/Sprites/male/Ranger/pose3.png";
            $(".infoTitle").empty();
            ...
            charSprite = "/public/images/Sprites/male/Rogue/pose3.png";
            $(".infoTitle").empty();
            ...
            charSprite = "/public/images/Sprites/male/Sorcerer/pose3.png";
            $(".infoTitle").empty();
            ...
            charSprite = "/public/images/Sprites/male/Warlock/pose3.png";
            $(".infoTitle").empty();
            ...
            charSprite = "/public/images/Sprites/male/Warlord/pose3.png";
            $(".infoTitle").empty();
            ...
            charSprite = "/public/images/Sprites/male/Wizard/pose3.png";
            $(".infoTitle").empty();
